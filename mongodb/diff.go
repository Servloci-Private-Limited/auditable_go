...
// ChangeComputer is the swappable BSON/JSON diff boundary. Implementations
// must honor context cancellation and must not call back into the same audited
...
// DeferredChangeHandler durably stores/enqueues an oversized diff request. A
// typical implementation writes snapshots to object storage, enqueues a job,
// and returns the object/job reference without computing the diff inline.
